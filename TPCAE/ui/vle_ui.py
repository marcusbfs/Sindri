...
#
# Created: Wed Apr 10 10:49:30 2019
...
class Ui_FormVLE(object):
    def setupUi(self, FormVLE):
        ...
        self.gridLayout_8.addWidget(self.checkBox_ploty, 7, 1, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.checkBox_plotx, 7, 0, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.checkBox_plotxy, 7, 2, 1, 1)
        ...
        self.gridLayout_8.addWidget(self.btn_saveToTxtBinaryMixData, 10, 2, 1, 2)
        ...
        self.gridLayout_8.addWidget(self.btn_fitKij, 6, 3, 1, 1)
