...
#
# Created: Sun Mar 24 22:40:13 2019
...
class Ui_FormVLE(object):
    def setupUi(self, FormVLE):
        ...
        self.gridLayout_4.addWidget(self.le_Pvalue, 3, 1, 1, 2)
        self.comboBox_Tunit = QtWidgets.QComboBox(self.frame)
        self.comboBox_Tunit.setObjectName("comboBox_Tunit")
        self.gridLayout_4.addWidget(self.comboBox_Tunit, 2, 3, 1, 1)
        ...
        self.gridLayout_4.addWidget(self.comboBox_CalcType, 1, 1, 1, 3)
        ...
        self.gridLayout_4.addWidget(self.comboBox_Punit, 3, 3, 1, 1)
        self.le_Tvalue = QtWidgets.QLineEdit(self.frame)
        self.le_Tvalue.setObjectName("le_Tvalue")
        self.gridLayout_4.addWidget(self.le_Tvalue, 2, 1, 1, 2)
        self.comboBox_EOS = QtWidgets.QComboBox(self.frame)
        self.comboBox_EOS.setObjectName("comboBox_EOS")
        self.gridLayout_4.addWidget(self.comboBox_EOS, 0, 1, 1, 3)
        ...
        self.gridLayout_4.addWidget(self.groupBox_2, 4, 0, 1, 4)
        ...
        self.gridLayout_4.addWidget(self.btn_calculate, 5, 1, 1, 2)
        ...
        self.gridLayout_8.addWidget(self.checkBox_plotExpData, 3, 0, 1, 3)
        self.btn_plot = QtWidgets.QPushButton(self.frame_2)
        self.btn_plot.setObjectName("btn_plot")
        self.gridLayout_8.addWidget(self.btn_plot, 4, 0, 1, 2)
        ...
        self.btn_saveToTxt = QtWidgets.QPushButton(self.frame_2)
        self.btn_saveToTxt.setObjectName("btn_saveToTxt")
        self.gridLayout_8.addWidget(self.btn_saveToTxt, 4, 2, 1, 2)
        ...
        self.gridLayout_2.addWidget(self.tabWidget_VLE, 0, 0, 1, 1)
    ...
    def retranslateUi(self, FormVLE):
        ...
        self.btn_saveToTxt.setText(QtWidgets.QApplication.translate("FormVLE", "Save to txt", None, -1))
