...
class Ui_PureSubstanceCalculationsWindow(object):
    def setupUi(self, PureSubstanceCalculationsWindow):
        ...
        PureSubstanceCalculationsWindow.setTabOrder(self.le_searchSubstance, self.listWidget_eos_options)
        PureSubstanceCalculationsWindow.setTabOrder(self.listWidget_eos_options, self.le_procT)
        ...
        PureSubstanceCalculationsWindow.setTabOrder(self.btn_tables, self.tableWidget_searchSubstance)
        PureSubstanceCalculationsWindow.setTabOrder(self.tableWidget_searchSubstance, self.comboBox_procTunit)
        PureSubstanceCalculationsWindow.setTabOrder(self.comboBox_procTunit, self.plainTextEdit_results)
        PureSubstanceCalculationsWindow.setTabOrder(self.plainTextEdit_results, self.comboBox_procPunit)
        PureSubstanceCalculationsWindow.setTabOrder(self.comboBox_procPunit, self.btn_diagrams)
        PureSubstanceCalculationsWindow.setTabOrder(self.btn_diagrams, self.comboBox_refTunit)
        PureSubstanceCalculationsWindow.setTabOrder(self.comboBox_refTunit, self.btn_searchSubstance)
        PureSubstanceCalculationsWindow.setTabOrder(self.btn_searchSubstance, self.comboBox_refPunit)
    ...
    def retranslateUi(self, PureSubstanceCalculationsWindow):
        ...
        self.groupBox_resultstxt.setTitle(
            QtWidgets.QApplication.translate("PureSubstanceCalculationsWindow", "Results", None, -1))
        ...
        self.btn_diagrams.setText(
            QtWidgets.QApplication.translate("PureSubstanceCalculationsWindow", "Diagrams", None, -1))
        self.btn_tables.setText(QtWidgets.QApplication.translate("PureSubstanceCalculationsWindow", "Tables", None, -1))
        ...
        self.btn_searchSubstance.setText(
            QtWidgets.QApplication.translate("PureSubstanceCalculationsWindow", "Search", None, -1))
